...
def load_model():
    with gzip.open('best_random_forest_model_compressed.pkl.gz', 'rb') as file:
...
def page1():
    ...
    st.image("Marketing-campaign-image-for-article-4939049309430393093.jpg", use_column_width=True)
...
def page2():
    ...
    st.image("Finance-and-Retail-Banking-Blog-Post.jpg", use_column_width=True)
